---
layout: default
title: Ryu Certification - Centec V150
---
...
<pre>
    ethernet/ipv4/tcp-->'eth_type=0x0800,actions=push_vlan:0x8100,set_field:100->vlan_id,output:2'       ERROR
        Added incorrect flows: flow_stats({'OFPMatch': {'type': 1, 'length': 12, 'oxm_fields': [{'OXMTlv': {'field': 'in_port', 'mask': None, 'value': 2}}]}} != {'OFPMatch': {'type': 1, 'length': 10, 'oxm_fields': [{'OXMTlv': {'field': 'eth_type', 'mask': None, 'value': 2048}}]}}), flow_stats([OFPInstructionActions(actions=[OFPActionPushVlan(ethertype=33024,len=8,type=17), OFPActionSetField(vlan_vid=100), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=48,type=4)] != [OFPInstructionActions(actions=[OFPActionPushVlan(ethertype=33024,len=8,type=17), OFPActionSetField(vlan_vid=4196), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=48,type=4)])
    ethernet/ipv6/tcp-->'eth_type=0x86dd,actions=push_vlan:0x8100,set_field:100->vlan_id,output:2'       ERROR
        Added incorrect flows: flow_stats({'OFPMatch': {'type': 1, 'length': 12, 'oxm_fields': [{'OXMTlv': {'field': 'in_port', 'mask': None, 'value': 2}}]}} != {'OFPMatch': {'type': 1, 'length': 10, 'oxm_fields': [{'OXMTlv': {'field': 'eth_type', 'mask': None, 'value': 34525}}]}}), flow_stats([OFPInstructionActions(actions=[OFPActionPushVlan(ethertype=33024,len=8,type=17), OFPActionSetField(vlan_vid=100), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=48,type=4)] != [OFPInstructionActions(actions=[OFPActionPushVlan(ethertype=33024,len=8,type=17), OFPActionSetField(vlan_vid=4196), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=48,type=4)])
    ethernet/arp-->'eth_type=0x0806,actions=push_vlan:0x8100,set_field:100->vlan_id,output:2'            ERROR
        Added incorrect flows: flow_stats({'OFPMatch': {'type': 1, 'length': 12, 'oxm_fields': [{'OXMTlv': {'field': 'in_port', 'mask': None, 'value': 2}}]}} != {'OFPMatch': {'type': 1, 'length': 10, 'oxm_fields': [{'OXMTlv': {'field': 'eth_type', 'mask': None, 'value': 2054}}]}}), flow_stats([OFPInstructionActions(actions=[OFPActionPushVlan(ethertype=33024,len=8,type=17), OFPActionSetField(vlan_vid=100), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=48,type=4)] != [OFPInstructionActions(actions=[OFPActionPushVlan(ethertype=33024,len=8,type=17), OFPActionSetField(vlan_vid=4196), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=48,type=4)])
</pre>
...
<pre>
    ethernet/vlan(vid=100)/ipv4/tcp-->'vlan_vid=100,actions=set_field:203->vlan_vid,output:2'            ERROR
        Added incorrect flows: flow_stats([OFPInstructionActions(actions=[OFPActionSetField(vlan_vid=203), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=40,type=4)] != [OFPInstructionActions(actions=[OFPActionSetField(vlan_vid=4299), OFPActionOutput(len=16,max_len=65509,port=2,type=0)],len=40,type=4)]), flow_stats({'OFPMatch': {'type': 1, 'length': 12, 'oxm_fields': [{'OXMTlv': {'field': 'in_port', 'mask': None, 'value': 2}}]}} != {'OFPMatch': {'type': 1, 'length': 10, 'oxm_fields': [{'OXMTlv': {'field': 'vlan_vid', 'mask': None, 'value': 4196}}]}})
...
..........
    2Mbps(ethernet(dst=random,src=random)/ipv4/tcp)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 0.00kbps, {'in_port': 3} 2003.74kbps
..........
    2Mbps(ethernet(dst=random,src=random)/ipv6/tcp)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 1983.43kbps, {'in_port': 3} 0.00kbps
..........
...
..........
    2Mbps(ethernet/ipv6(src=random,dst=random)/tcp(src_port=random,dst_port=random))-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 2019.31kbps, {'in_port': 3} 0.00kbps
..........
...
<pre>
    2Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:1Mbps(drop),output:2'                            ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDrop(burst_size=1024,len=16,rate=1000,type=1)] != [OFPMeterBandDrop(burst_size=0,len=16,rate=1000,type=1)])
...
<pre>
    20Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:10Mbps(drop),output:2'                          ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDrop(burst_size=1024,len=16,rate=10000,type=1)] != [OFPMeterBandDrop(burst_size=0,len=16,rate=10000,type=1)])
...
<pre>
    200Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:100Mbps(drop),output:2'                        ERROR
        Added incorrect meters: meter_stats([OFPMeterBandDrop(burst_size=1024,len=16,rate=100000,type=1)] != [OFPMeterBandDrop(burst_size=0,len=16,rate=100000,type=1)])
