...
<pre>
    ethernet/ipv4(tos=32)/tcp-->'ip_dscp=8,actions=output:2'                                             ERROR
        Added incorrect flows: flow_stats({'OFPMatch': {'type': 1, 'length': 15, 'oxm_fields': [{'OXMTlv': {'field': 'eth_type', 'mask': None, 'value': 2048}}, {'OXMTlv': {'field': 'ip_dscp', 'mask': None, 'value': 32}}]}} != {'OFPMatch': {'type': 1, 'length': 15, 'oxm_fields': [{'OXMTlv': {'field': 'eth_type', 'mask': None, 'value': 2048}}, {'OXMTlv': {'field': 'ip_dscp', 'mask': None, 'value': 8}}]}}), flow_stats({'OFPMatch': {'type': 1, 'length': 12, 'oxm_fields': [{'OXMTlv': {'field': 'in_port', 'mask': None, 'value': 2}}]}} != {'OFPMatch': {'type': 1, 'length': 15, 'oxm_fields': [{'OXMTlv': {'field': 'eth_type', 'mask': None, 'value': 2048}}, {'OXMTlv': {'field': 'ip_dscp', 'mask': None, 'value': 8}}]}})
...
..........
    2Mbps(ethernet(dst=random,src=random)/ipv4/tcp)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 0.00kbps, {'in_port': 3} 2023.19kbps
..........
    2Mbps(ethernet(dst=random,src=random)/ipv6/tcp)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 2019.74kbps, {'in_port': 3} 0.00kbps
..........
...
..........
    2Mbps(ethernet/ipv6(src=random,dst=random)/tcp(src_port=random,dst_port=random))-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 2022.11kbps, {'in_port': 3} 0.00kbps
..........
    2Mbps(ethernet/arp(src_ip=random,dst_ip=random)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Received unexpected throughput: {'in_port': 2} 2021.31kbps, {'in_port': 3} 0.00kbps
</pre>
