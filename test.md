...
|[DROP_00_KBPS_02_100M](https://github.com/osrg/ryu/tree/master/ryu/tests/switch/of13/meter/01_DROP_00_KBPS_02_100M.json)|- | [ERROR](#374de7cf3ba3cd6962f98683ef2d0ee5) | [ERROR](#374de7cf3ba3cd6962f98683ef2d0ee5) |
...
<pre>
    ...
    ethernet/ipv6/tcp-->'actions=output:2'                                                               ERROR
        Failed to initialize flow tables of tester_sw: barrier request timeout.
...
<pre>
    ...
    ethernet/itag/ethernet/ipv4(dst='192.168.20.20')/tcp-->'actions=pop_pbb,goto_table:1','table_id:1,ipv4_dst=192.168.20.20,actions=output:CONTROLLER' ERROR
        Received incorrect packet: ethernet(src='d8:9d:67:1e:40:f1',dst='33:33:00:00:00:16',ethertype=34525)/ipv6(dst='ff02::16',ext_hdrs=[hop_opts(data=[option(data='\x00\x00',len_=2,type_=5), option(data=None,len_=0,type_=1)],nxt=58,size=0)],flow_label=0,hop_limit=1,nxt=0,payload_length=36,src='::',traffic_class=0,version=6)/icmpv6(code=0,csum=11899,data=mldv2_report(record_num=1,records=[mldv2_report_group(address='ff02::1:ff1e:40f1',aux=None,aux_len=0,num=0,srcs=[],type_=4)]),type_=143)
...
<pre>
    ...
    ethernet/vlan/ipv4(dst='192.168.20.20')/tcp-->'ipv4_dst=192.168.0.20(mask=255.255.0.255),actions=output:2' ERROR
        Received incorrect packet: ethernet(src='d8:9d:67:1e:40:f1',dst='33:33:00:00:00:02',ethertype=34525)/ipv6(dst='ff02::2',ext_hdrs=[],flow_label=0,hop_limit=255,nxt=58,payload_length=16,src='fe80::da9d:67ff:fe1e:40f1',traffic_class=0,version=6)/icmpv6(code=0,csum=31187,data=nd_router_solicit(option=nd_option_sla(data=None,hw_src='d8:9d:67:1e:40:f1',length=1),res=0),type_=133)
...
<pre>
    2Mbps(ethernet(dst=random,src=random)/ipv4/tcp)-->'in_port=1,actions=group:select(actions=output:2/actions=output:3)' ERROR
        Failed to add flows to tester_sw: barrier request timeout.
...
..........
    20Mbps(ethernet/ipv4/tcp)-->'in_port=1,actions=meter:10Mbps(drop),output:2'                          ERROR
        Received unexpected throughput: {'in_port': 2} 2431.10kbps
..........
    20Mbps(ethernet/ipv6/tcp)-->'in_port=1,actions=meter:10Mbps(drop),output:2'                          ERROR
        Received unexpected throughput: {'in_port': 2} 2484.21kbps
..........
    20Mbps(ethernet/arp)-->'in_port=1,actions=meter:10Mbps(drop),output:2'                               ERROR
        Received unexpected throughput: {'in_port': 2} 2530.76kbps
</pre>
...
..........
    20Mbps(ethernet/ipv4(dscp=18)/tcp)-->'in_port=1,actions=meter:10Mbps(dscp_remark:ip_dscp=20),output:2' ERROR
        Received unexpected throughput: {'eth_type': 2048, 'in_port': 2, 'ip_dscp': 20} 0.00kbps, {'eth_type': 2048, 'in_port': 2, 'ip_dscp': 18} 2428.76kbps
..........
    20Mbps(ethernet/ipv6(dscp=18)/tcp)-->'in_port=1,actions=meter:10Mbps(dscp_remark:ip_dscp=20),output:2' ERROR
        Received unexpected throughput: {'eth_type': 34525, 'in_port': 2, 'ip_dscp': 18} 2474.41kbps, {'eth_type': 34525, 'in_port': 2, 'ip_dscp': 20} 0.00kbps
..........
    20Mbps(ethernet/arp)-->'in_port=1,actions=meter:20Mbps(dscp_remark:prec_level=1),output:2'           ERROR
        Received unexpected throughput: {'in_port': 2} 11385.16kbps
</pre>
...
..........
    200Mbps(ethernet/ipv4(dscp=18)/tcp)-->'in_port=1,actions=meter:100Mbps(dscp_remark:ip_dscp=20),output:2' ERROR
        Received unexpected throughput: {'eth_type': 2048, 'in_port': 2, 'ip_dscp': 20} 0.00kbps, {'eth_type': 2048, 'in_port': 2, 'ip_dscp': 18} 5754.92kbps
..........
    200Mbps(ethernet/ipv6(dscp=18)/tcp)-->'in_port=1,actions=meter:100Mbps(dscp_remark:ip_dscp=20),output:2' ERROR
        Received unexpected throughput: {'eth_type': 34525, 'in_port': 2, 'ip_dscp': 20} 0.00kbps, {'eth_type': 34525, 'in_port': 2, 'ip_dscp': 18} 5842.35kbps
..........
    200Mbps(ethernet/arp)-->'in_port=1,actions=meter:200Mbps(dscp_remark:prec_level=1),output:2'         ERROR
        Received unexpected throughput: {'in_port': 2} 8708.87kbps
</pre>
